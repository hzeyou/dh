    ...
    for (let i = 0; i < this.columnNum; i++) {
      for (let j = 0; j < this.rowNum; j++) {
        if (this.cells[i][j].node) {
          var _this$cells$i$j, _this$cells$i$j$node;
          if (((_this$cells$i$j = this.cells[i][j]) === null || _this$cells$i$j === void 0 ? void 0 : (_this$cells$i$j$node = _this$cells$i$j.node) === null || _this$cells$i$j$node === void 0 ? void 0 : _this$cells$i$j$node.id) === nodeId) {
            return {
              column: i,
              row: j
            };
