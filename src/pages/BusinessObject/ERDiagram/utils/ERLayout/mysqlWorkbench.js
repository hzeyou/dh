...
function layout(nodes, edges) {
  ...
  nodes.sort((node1, node2) => {
    var _nodeEdgeMap$get, _nodeEdgeMap$get2;
    return ((_nodeEdgeMap$get = nodeEdgeMap.get(node1.id)) === null || _nodeEdgeMap$get === void 0 ? void 0 : _nodeEdgeMap$get.length) - ((_nodeEdgeMap$get2 = nodeEdgeMap.get(node2.id)) === null || _nodeEdgeMap$get2 === void 0 ? void 0 : _nodeEdgeMap$get2.length);
  });
