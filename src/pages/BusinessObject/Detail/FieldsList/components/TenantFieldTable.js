...
import { hasMaxLengthFieldList } from "hzero-front-hmde/lib/routes/BusinessObject/Detail/FieldsList/AddAndEditField/utils";
import { useStore } from "../store";
import { validationRenderer, handleDealFields, componentTypeFilter } from "../utils";
import styles from "../index.less?modules";
import MorePropsIcon from "./MoreProps";
const isTenant = isTenantRoleLevel();
const FieldList = props => {
  var _baseInfoDS$current, _baseInfoDS$current2, _boStore$getState;
  const buttons = props.buttons,
    ...
    _props$getAddonBefore = props.getAddonBefore,
    getAddonBefore = _props$getAddonBefore === void 0 ? '' : _props$getAddonBefore,
    physicalModelType = props.physicalModelType,
    baseInfoDS = props.baseInfoDS;
  // 租户层SQL对象不可修改基础信息
  const sourceType = baseInfoDS === null || baseInfoDS === void 0 ? void 0 : (_baseInfoDS$current = baseInfoDS.current) === null || _baseInfoDS$current === void 0 ? void 0 : _baseInfoDS$current.get('sourceType');
  const tenantSqlObjectDisabled = isTenant && (baseInfoDS === null || baseInfoDS === void 0 ? void 0 : (_baseInfoDS$current2 = baseInfoDS.current) === null || _baseInfoDS$current2 === void 0 ? void 0 : _baseInfoDS$current2.get('physicalModelType')) === PhysicalModelType.SQL && sourceType === SourceType.INHERIT;
  ...
  // const isApiType = baseInfoDS?.current?.get('physicalModelType') === 'API';
  ...
  const columns = useMemo(() => {
    return [{
      ...
      editor: record => {
        // 下面的条件取反
        const canEditflag = !(record !== null && record !== void 0 && record.get('standardFlag') || !(record !== null && record !== void 0 && record.getState('editing')) || [FieldType.PREDEFINED].includes(record === null || record === void 0 ? void 0 : record.get('sourceType')));
        return canEditflag;
      },
      renderer: ({
        record,
        ...
        if (record !== null && record !== void 0 && record.get('standardFlag') || !(record !== null && record !== void 0 && record.getState('editing')) || [FieldType.PREDEFINED].includes(record === null || record === void 0 ? void 0 : record.get('sourceType'))) {
          return /*#__PURE__*/React.createElement("a", {
            onClick: () => handleDetail(record, FieldType.STANDARD)
          }, record === null || record === void 0 ? void 0 : record.get('businessObjectFieldName'));
        }
        return text;
      }
    }, {
      ...
      renderer: ({
        name,
        record
      }) => !(record !== null && record !== void 0 && record.get('standardFlag')) && ![FieldType.PREDEFINED, FieldType.STANDARD, FieldType.INHERIT].includes(record === null || record === void 0 ? void 0 : record.get('sourceType')) && !!(record !== null && record !== void 0 && record.getState('editing')) && creating && !tenantSqlObjectDisabled ? /*#__PURE__*/React.createElement(_TextField, {
        ...
        showLengthInfo: true,
        name: "businessObjectFieldCode",
        value: record === null || record === void 0 ? void 0 : record.get('businessObjectFieldCode'),
        onChange: val => handleChange({
          value: val,
          record,
          name
        }),
        validationRenderer: res => validationRenderer(res, '字段编码')
      }) : record === null || record === void 0 ? void 0 : record.get('businessObjectFieldCode')
      ...
      width: 130,
      sortable: true,
      editor: r => !tenantSqlObjectDisabled && !(r !== null && r !== void 0 && r.get('standardFlag')) && ![FieldType.PREDEFINED, FieldType.STANDARD, FieldType.INHERIT].includes(r === null || r === void 0 ? void 0 : r.get('sourceType')) && !!(r !== null && r !== void 0 && r.getState('editing')) && /*#__PURE__*/React.createElement(_Select, {
        searchable: true,
        optionsFilter: option => componentTypeFilter(option, r, physicalModelType, baseInfoDS)
      })
    }, {
      name: 'maxLength',
      align: 'left',
      ...
      editor: r => !(r !== null && r !== void 0 && r.get('standardFlag')) && ![FieldType.PREDEFINED, FieldType.STANDARD, FieldType.INHERIT].includes(r === null || r === void 0 ? void 0 : r.get('sourceType')) && !!(r !== null && r !== void 0 && r.getState('editing')) && [FieldComponentType.LINK_RELATION, FieldComponentType.MASTER_RELATION, FieldComponentType.MULTIPLE_RELATION].includes(r === null || r === void 0 ? void 0 : r.get('componentType'))
    } : {
      ...
      renderer: ({
        ...
        if (record !== null && record !== void 0 && record.get('standardFlag') || !(record !== null && record !== void 0 && record.getState('editing')) || [FieldType.PREDEFINED].includes(record === null || record === void 0 ? void 0 : record.get('sourceType')) || tenantSqlObjectDisabled) {
          return yesOrNoRender(value ? 1 : 0);
        }
        return /*#__PURE__*/React.createElement(_Switch, {
          name: "requiredFlag",
          checked: value,
          disabled: [FieldComponentType.SWITCH, FieldComponentType.MASTER_RELATION, FieldComponentType.FORMULA, FieldComponentType.REFERENCE_FIELD].includes(record === null || record === void 0 ? void 0 : record.get('componentType')) || [FieldType.STANDARD].includes(record === null || record === void 0 ? void 0 : record.get('sourceType')) && (record === null || record === void 0 ? void 0 : record.getState('requiredFlagDisabled')),
          onChange: val => {
            handleChange({
              value: val,
              record,
    ...
    // 其他属性
    {
      ...
      name: 'remark',
      editor: r => !(r !== null && r !== void 0 && r.get('standardFlag')) && ![FieldType.PREDEFINED, FieldType.STANDARD, FieldType.INHERIT].includes(r === null || r === void 0 ? void 0 : r.get('sourceType')) && !!(r !== null && r !== void 0 && r.getState('editing')) && !(r !== null && r !== void 0 && r.get('standardFlag'))
      ...
      renderer: ({
        ...
        const getDeleteBtn = () => {
          ...
          return editing || creating && !record.getState('editing') ? /*#__PURE__*/React.createElement("span", {
            ...
            trigger: "click",
            placement: "top",
            visible: (record === null || record === void 0 ? void 0 : record.getState('visible')) && hasPermission,
        ...
        if (isTenant) {
          ...
          if (![FieldType.STANDARD, FieldType.PREDEFINED].includes(record === null || record === void 0 ? void 0 : record.get('sourceType')) || (baseInfoDS === null || baseInfoDS === void 0 ? void 0 : (_baseInfoDS$current3 = baseInfoDS.current) === null || _baseInfoDS$current3 === void 0 ? void 0 : _baseInfoDS$current3.get('physicalModelType')) === 'API') {
            // 标准字段包含了预置字段
            list.push(operators[0]);
            record === null || record === void 0 ? void 0 : record.setState('deleteFlag', true);
          }
        }
        // return canEdit && !isApiType ? operatorRender(list, record, { limit: 3 }) : null;
  ...
  }, [readOnlyFlag, activeKey, creating, predefineDisabled, isTenant, tenantSqlObjectDisabled, editing]);
  useDataSetEvents(tableDS, 'load', () => {
    tableDS.forEach(r => {
      if (!(r !== null && r !== void 0 && r.get('standardFlag')) && ![FieldType.PREDEFINED, FieldType.STANDARD, FieldType.INHERIT].includes(r === null || r === void 0 ? void 0 : r.get('sourceType'))) {
        r === null || r === void 0 ? void 0 : r.setState('oldComponentTypeValue', r === null || r === void 0 ? void 0 : r.get('componentType'));
      }
    });
  });
  ...
  return /*#__PURE__*/React.createElement(_Table, {
    ...
    // buttons={isApiType ? [] : buttons}
    ,
    buttons: buttons,
    className: styles['tenant-field-table'],
    queryFields: {
